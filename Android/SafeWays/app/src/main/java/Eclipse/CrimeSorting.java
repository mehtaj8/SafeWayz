<<<<<<< HEAD:Java/SafeWays/app/src/main/java/Eclipse/CrimeSorting.java
package Eclipse;

/** @file CrimeSearch.java
 @author Jash Mehta
 @brief Sorts Streets based on crime data for Bonus feature
...
public class CrimeSorting {
	...
	public static Map<String, Integer> crimeSort(String input, Map<String, Object> hashtable) {
		if (validKey(input, hashtable)) {
			...
			// Takes all values from the hashtable and saves it into a 2D array
			int i = 0;
			...
			for (Map.Entry mapElement : inner_hashmap.entrySet()) { // Iterates through the inner_hashmap
			...
			for(int j = 0; j < entries.length; j++) {
				final_hashmap.put(entries[j][0], Integer.parseInt(entries[j][1])); // Saves values into new hashmap
			}
...
>>>>>>> ba7814a03e02346e98e2d9c739d0d1b08d9201c4:Android/SafeWays/app/src/main/java/Eclipse/CrimeSorting.java
