...
import final_proj.Extras.StdRandom;
...
public class CrimeSorting {
	...
	public static Map<String, Integer> crimeSort(String input) {
		if (validKey(input)) {
			...
			for (Map.Entry mapElement : inner_hashmap.entrySet()) { // Iterates through inner_hashmap
...
//		String starting = "JOHNFKENNEDY DR";
//		Map<String, Integer> sorted = crimeSort(starting);
