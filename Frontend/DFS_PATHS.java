        ...
        go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    String path = least_crime_path.toString();
                    ...
                    String[] GMAPS_path;
                    //used to clean data before sending to GMaps
                    String[] wierdformat = {"01ST ST","02ND ST","03RD ST","04TH ST","05TH ST","06TH ST","07TH ST","08TH ST","09TH ST"};
                    ...
                    if(least_crime_path.size()>=2){
                        ...
                        output.setText(Arrays.toString(GMAPS_path));
