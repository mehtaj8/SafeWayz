...
- Video Demonstrations can be found in the 'Video Demonstration' folder
...
- IMPORTANT: Import the external JAR files via Project->Properties .> Java Build path. Checkout Step 4 of the quickstart guide for more details.
- Remove any of the existing JARs. Add the new ones available in the JAVA-ECLIPSE-TERMINAL -> 2XB3PROJECT -> src -> final_proj -> JarModules folder.
